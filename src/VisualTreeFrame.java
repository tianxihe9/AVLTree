...
public class VisualTreeFrame extends JFrame {
	...
	class ControlPanel extends JPanel {
		...
		public ControlPanel() {
			...
			// ///////////////slider
			JSlider TXControl = new JSlider(SwingConstants.HORIZONTAL, 50, 300, 60);
	...
	class Panel extends JPanel {
		...
		public void drawRec(Node n, AVLTree.BinaryNode par, Graphics2D comp2D, double tx, double ty) {
			double TRANSX = tx;
			double TRANSY = ty;
			double x = n.CenterX;
			double y = n.CenterY;
		...
		class Node extends JComponent {
			...
			public void drawOn(Graphics2D g2) {
				Ellipse2D.Double cir = new Ellipse2D.Double(this.CenterX, this.CenterY, this.radius + 5, this.radius);
				g2.draw(cir);
